    ...
    public partial class InitialMigration : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "MarcaA", "Comida", "Alimento balanceado para perros", "https://example.com/imagen1.jpg", "Comida para perros", 20.5, 50 },
                    { 2, "MarcaB", "Juguetes", "Juguete interactivo para gatos", "https://example.com/imagen2.jpg", "Juguete para gatos", 15.0, 30 }
                });
